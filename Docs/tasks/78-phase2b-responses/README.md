...
Doc détaillée par lot : [#82 mentor notifications](../82-mentor-notifications/README.md) · [#83 filtrage certifications](../83-response-filtering/README.md).
...
Voir [83-response-filtering/README.md](../83-response-filtering/README.md).
...
2. Fiche demande mentor — toggle « Filtrer par certifications » : réponses hors tags masquées, demandeur toujours visible.
