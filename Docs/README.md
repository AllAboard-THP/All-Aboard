...
**Livré** (2026-05-12) : feed SSR `API_URL`, TanStack home, BFF `/api/feed` — [journal](plan-mise-en-place-web-api-donnees.md).
...
| [adr/README.md](adr/README.md) | ADR validés (post-merge). |
...
| 2 — Auth + parcours demande d’aide | **En cours** | Project epic [#13](https://github.com/AllAboard-THP/All-Aboard/issues/13), [MOC](moc-parcours-utilisateur.md) |
...
| Zone | État |
|------|------|
| `apps/api` | Fastify, `/health`, `/feed` mock ; pas d’auth métier. |
| `apps/web` | SSR feed, BFF, TanStack home. |
| Auth | Phase 2 — [#18](https://github.com/AllAboard-THP/All-Aboard/issues/18)+ |
