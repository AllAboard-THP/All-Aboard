...
import { CreatePostModal } from "./legacy-modal-patterns";

export type MobileNavLink = "feed" | "explore" | "messages" | "profile";

export function MobileBottomNav({
  activeLink: activeLinkProp = "feed",
  messageCount = 0,
  userInitials = "HB",
  showMentorDot = false,
  ...
  const [activeLink, setActiveLink] = useState(activeLinkProp);
    ...
    <>
      ...
      >
        <div className="flex h-16 items-center justify-around">
          ...
          <button
            type="button"
            className={cn(linkClass("messages"), "relative")}
          ...
          <button
            type="button"
            className={cn(linkClass("profile"), "relative")}
