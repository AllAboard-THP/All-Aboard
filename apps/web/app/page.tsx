    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <p style={{ margin: 0, color: "#818cf8", fontWeight: 700, fontSize: "13px" }}>
              Feed social cible
            </p>
          ...
          >
            <p style={{ margin: 0, color: "#c084fc", fontWeight: 700, fontSize: "13px" }}>
              Chat temps reel
            </p>
            <p style={{ margin: "6px 0 0", color: "#cbd5e1", fontSize: "14px" }}>
          ...
          >
            <p style={{ margin: 0, color: "#2dd4bf", fontWeight: 700, fontSize: "13px" }}>
