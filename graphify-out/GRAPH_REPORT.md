...
## Summary
- 1576 nodes · 2542 edges · 126 communities (114 shown, 12 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 108 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `207784b0`
...
1. `cn()` - 109 edges
2. `useLegacyLabels()` - 76 edges
3. `patternStoryParameters` - 27 edges
4. `withPatternStoryFrame()` - 25 edges
5. `Button()` - 25 edges
6. `getApiBaseUrl()` - 19 edges
7. `useAlertLabels()` - 18 edges
8. `compilerOptions` - 18 edges
9. `LegacyLabels` - 15 edges
10. `legacyLabelsFr` - 15 edges
...
Cohesion: 0.07
Nodes (39): usePostCardLabels(), CommentCardDefault, CommentCardStory(), ContributionListItemDefault, FeedSearchCardDefault, QuickReplyDefault, QuickReplyStory(), ScrollToTopFabVisible (+31 more)
...
Cohesion: 0.09
Nodes (25): LegacyConversation, legacyConversations, legacyConversationsEn, LegacyFeedComment, legacyFeedThreadComments, legacyFeedThreadCommentsEn, LegacyRecentlyViewedPost, LegacyProfile (+17 more)

### Community 5 - "Community 5"
Cohesion: 0.09
Nodes (26): Checkbox(), Dialog(), DialogContent(), DialogDescription(), DialogFooter(), DialogHeader(), DialogOverlay(), DialogTitle() (+18 more)
...
Cohesion: 0.08
Nodes (24): AdminDashboard, AdminModeration, AdminUsers, EventsList, EventsListMobile, ExploreSubjects, FeedThreeColumn, FeedThreeColumnMobile (+16 more)
...
Cohesion: 0.10
Nodes (17): Skeleton(), AlertCatalog, BadgeCatalog, ButtonCatalog, CardCatalog, InputCatalog, LabelCatalog, ListingComplet (+9 more)
...
Cohesion: 0.14
Nodes (21): useLegacyEvents(), useLegacyLabels(), useLegacyProfile(), EventCardStory(), EventListStory(), EventsSectionStory(), ProfileAboutCard(), ProfileActivityTabs() (+13 more)
...
Cohesion: 0.11
Nodes (17): AllAboardLogoMark(), Default, Sizes, Story, BrandLogoDefault, BrandLogoStory(), EyebrowDefault, EyebrowStory() (+9 more)

### Community 23 - "Community 23"
Cohesion: 0.13
Nodes (15): getLegalPageContent(), legacyLegalCguEn, legacyLegalCguFr, legacyLegalMentionsEn, legacyLegalMentionsFr, legacyLegalPrivacyEn, legacyLegalPrivacyFr, LegalPageContent (+7 more)
...
Cohesion: 0.16
Nodes (14): legacyMentorDashboard, legacyMentorDashboardEn, MentorDashboardFixture, MentorHelpPost, MentorPendingResource, ModerationItemActions(), actionToneClass, AdminActionButton() (+6 more)

### Community 27 - "Community 27"
Cohesion: 0.19
Nodes (16): useLegacyAdminUsers(), useLegacyFeedThreadComments(), useLegacyModeration(), usePostCardFixture(), useStorybookLocale(), AdminModerationQueueDefault, AdminUsersTableDefault, ModerationStory() (+8 more)
...
Cohesion: 0.19
Nodes (8): DropdownMenuCheckboxItem(), DropdownMenuLabel(), DropdownMenuRadioItem(), DropdownMenuShortcut(), DropdownMenuSubContent(), DropdownMenuSubTrigger(), cn(), hidden
...
Cohesion: 0.20
Nodes (9): Button(), buttonVariants, button, AllVariants, Error, Info, Story, Success (+1 more)

### Community 47 - "Community 47"
Cohesion: 0.14
Nodes (12): ProposeSubjectCard(), SubjectCard(), SubjectCardGrid(), SubjectTag(), Card, Grid, ProposeSubject, ProposeSubjectStory() (+4 more)

### Community 48 - "Community 48"
Cohesion: 0.19
Nodes (9): MobileBottomNav(), MobileNavLink, AppFooter(), AppNavBar(), AppChrome(), cnMainClass(), mobileStoryParameters, resolveMobileNavLink() (+1 more)

### Community 49 - "Community 49"
Cohesion: 0.16
Nodes (11): Default, FeedItemPlaceholder, Story, FeedEmpty, MentorFeedEmpty, NotFound, ResponsesEmpty, Story (+3 more)
...
Cohesion: 0.24
Nodes (10): Alert(), AlertDescription(), AlertTitle(), alertVariants, DuplicateError, HelpRequestFields, InlineError, RubberduckHint (+2 more)
...
Cohesion: 0.23
Nodes (8): AdminUserRow, legacyAdminUsers, legacyAdminUsersEn, legacyModeration, legacyModerationEn, ModerationFixture, ModerationFlaggedComment, ModerationFlaggedPost
...
Cohesion: 0.18
Nodes (10): Checked, Default, Disabled, Story, MobileBottomNavDefault, MobileBottomNavWithUnreadBadge, MobileNavStory(), Story (+2 more)
...
Cohesion: 0.25
Nodes (9): DropdownMenu(), DropdownMenuContent(), DropdownMenuItem(), DropdownMenuSeparator(), DropdownMenuTrigger(), Default, Story, navIcons (+1 more)

### Community 64 - "Community 64"
Cohesion: 0.18
Nodes (10): AppFooterDefault, AppNavBarDefault, FooterStory(), NavStory(), StatCardRow, StatCardsStory(), Story, UserMenuOpen (+2 more)
...
Cohesion: 0.27
Nodes (9): useLegacyLegalContent(), CguLayoutStory(), LegalPageLayoutCgu, LegalPageLayoutMentions, LegalPageLayoutPrivacy, MentionsLayoutStory(), PrivacyLayoutStory(), Story (+1 more)
...
Cohesion: 0.36
Nodes (6): LegacyResource, legacyResources, legacyResourcesEn, LegacySubject, legacySubjects, PageHeaderWithIcon()
...
## Knowledge Gaps
- **863 isolated node(s):** `__dirname`, `monorepoRoot`, `nextConfig`, `__dirname`, `$schema` (+858 more)
...
- **Why does `cn()` connect `Community 41` to `Community 1`, `Community 5`, `Community 11`, `Community 13`, `Community 14`, `Community 15`, `Community 16`, `Community 17`, `Community 22`, `Community 23`, `Community 25`, `Community 26`, `Community 27`, `Community 29`, `Community 35`, `Community 39`, `Community 40`, `Community 46`, `Community 47`, `Community 48`, `Community 49`, `Community 51`, `Community 54`, `Community 60`, `Community 63`, `Community 67`, `Community 75`, `Community 76`, `Community 87`?**
  _High betweenness centrality (0.023) - this node is a cross-community bridge._
- **Why does `useLegacyLabels()` connect `Community 15` to `Community 64`, `Community 1`, `Community 35`, `Community 4`, `Community 68`, `Community 5`, `Community 8`, `Community 14`, `Community 47`, `Community 48`, `Community 17`, `Community 54`, `Community 87`, `Community 22`, `Community 27`, `Community 61`?**
  _High betweenness centrality (0.017) - this node is a cross-community bridge._
- **Why does `Button()` connect `Community 46` to `Community 1`, `Community 4`, `Community 5`, `Community 11`, `Community 13`, `Community 14`, `Community 16`, `Community 26`, `Community 27`, `Community 40`, `Community 41`, `Community 49`, `Community 51`, `Community 52`, `Community 53`, `Community 63`, `Community 67`, `Community 75`, `Community 76`?**
