...
## Summary
- 1553 nodes · 2515 edges · 124 communities (114 shown, 10 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 108 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `942afca5`
...
5. `Button()` - 25 edges
6. `useAlertLabels()` - 18 edges
7. `compilerOptions` - 18 edges
8. `getApiBaseUrl()` - 17 edges
...
Cohesion: 0.08
Nodes (29): AdminUserRow, legacyAdminUsers, legacyAdminUsersEn, LegacyEvent, legacyEvents, legacyEventsEn, legacyModeration, legacyModerationEn (+21 more)
...
Cohesion: 0.09
Nodes (24): Default, Sizes, Story, AvatarImage(), Fallback, Sizes, Story, WithImage (+16 more)

### Community 7 - "Community 7"
Cohesion: 0.09
Nodes (26): LegacyFeedComment, legacyFeedThreadComments, legacyFeedThreadCommentsEn, LegacyRecentlyViewedPost, CommentCardDefault, ContributionListItemDefault, FeedSearchCardDefault, QuickReplyDefault (+18 more)
...
Cohesion: 0.18
Nodes (20): Card(), CardContent(), CardDescription(), CardFooter(), CardHeader(), CardTitle(), Default, FeedEmpty (+12 more)

### Community 10 - "Community 10"
Cohesion: 0.12
Nodes (20): LegacyResource, legacyResources, legacyResourcesEn, LegacySubject, legacySubjects, LegacyNavLink, navIcons, pillIcons (+12 more)
...
Cohesion: 0.10
Nodes (22): ProfileTabs, Story, Tabs(), TabsContent(), TabsList(), tabsListVariants, TabsTrigger(), useLegacyResources() (+14 more)

### Community 14 - "Community 14"
Cohesion: 0.09
Nodes (22): AdminDashboard, AdminModeration, AdminUsers, EventsList, EventsListMobile, ExploreSubjects, FeedThreeColumn, FeedThreeColumnMobile (+14 more)
...
Cohesion: 0.12
Nodes (21): useLegacyEvents(), useLegacyLabels(), EventCardStory(), EventListStory(), EventsSectionStory(), QuickReplyStory(), CreatePostModal(), SubjectRequestModal() (+13 more)
...
Cohesion: 0.20
Nodes (12): Checkbox(), Dialog(), DialogContent(), DialogDescription(), DialogFooter(), DialogHeader(), DialogTitle(), DialogTrigger() (+4 more)
...
Cohesion: 0.14
Nodes (13): Default, Disabled, Invalid, Story, WithLabel, textarea, Textarea(), DuplicateError (+5 more)
...
Cohesion: 0.17
Nodes (16): usePostCardFixture(), usePostCardLabels(), CommentCardStory(), PostCardActionsMenu(), ActionsMenu, ActionsMenuAdmin, ActionsMenuAdminStory(), ActionsMenuStory() (+8 more)
...
Cohesion: 0.18
Nodes (12): Alert(), AlertDescription(), AlertTitle(), alertVariants, EmptyStatePattern, ErrorAlertPattern, FeedItemCardPattern, FormFieldPattern (+4 more)
...
Cohesion: 0.28
Nodes (10): Avatar(), AvatarFallback(), LegacyConversation, legacyConversations, legacyConversationsEn, LegacyLabels, legacyLabelsFr, ConversationListItem() (+2 more)
...
Cohesion: 0.20
Nodes (11): legacyMentorDashboard, legacyMentorDashboardEn, MentorDashboardFixture, MentorHelpPost, MentorPendingResource, ModerationItemActions(), actionToneClass, AdminActionTone (+3 more)
...
Cohesion: 0.15
Nodes (12): AvatarBadge(), AvatarGroup(), AvatarGroupCount(), CardAction(), DialogOverlay(), cn(), hidden, AdminActionButton() (+4 more)

### Community 45 - "Community 45"
Cohesion: 0.20
Nodes (8): HomePage(), FeedClientPreview(), FeedItemCard(), formatCreatedAt(), HomeContent(), Props, fetchFeed(), mockFetch
...
Cohesion: 0.20
Nodes (8): MobileNavLink, AppFooter(), AppNavBar(), AppChrome(), cnMainClass(), mobileStoryParameters, resolveMobileNavLink(), screenStoryParameters
...
Cohesion: 0.24
Nodes (10): useLegacyLegalContent(), LegalPageLayout(), CguLayoutStory(), LegalPageLayoutCgu, LegalPageLayoutMentions, LegalPageLayoutPrivacy, MentionsLayoutStory(), PrivacyLayoutStory() (+2 more)
...
Cohesion: 0.27
Nodes (7): Button(), buttonVariants, button, DetailHero, FeedHero, MentorHero, Story
...
Cohesion: 0.25
Nodes (8): useLegacyAdminUsers(), useLegacyFeedThreadComments(), useLegacyModeration(), useStorybookLocale(), ModerationStory(), UsersTableStory(), AdminModerationScreen(), AdminUsersScreen()
...
Cohesion: 0.38
Nodes (4): Skeleton(), FeedList, RequestDetail, Story

### Community 86 - "Community 86"
Cohesion: 0.29
Nodes (6): FeedEmpty, MentorFeedEmpty, NotFound, ResponsesEmpty, Story, PatternDemoCardShell()
...
Cohesion: 0.29
Nodes (6): alert, createLink, cta, links, list, sampleFeed
...
Cohesion: 0.33
Nodes (5): ForgotPasswordFormDefault, ForgotPasswordFormStory(), RegisterFormDefault, RegisterFormStory(), Story
...
## Knowledge Gaps
- **848 isolated node(s):** `__dirname`, `monorepoRoot`, `nextConfig`, `__dirname`, `$schema` (+843 more)
...
- **Why does `cn()` connect `Community 44` to `Community 2`, `Community 6`, `Community 7`, `Community 9`, `Community 10`, `Community 12`, `Community 13`, `Community 19`, `Community 20`, `Community 21`, `Community 23`, `Community 25`, `Community 26`, `Community 28`, `Community 31`, `Community 33`, `Community 34`, `Community 36`, `Community 38`, `Community 39`, `Community 49`, `Community 56`, `Community 59`, `Community 60`, `Community 64`, `Community 85`, `Community 86`, `Community 87`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **Why does `useLegacyLabels()` connect `Community 16` to `Community 2`, `Community 34`, `Community 36`, `Community 6`, `Community 7`, `Community 9`, `Community 10`, `Community 13`, `Community 28`, `Community 14`, `Community 81`, `Community 49`, `Community 61`, `Community 23`, `Community 56`, `Community 27`, `Community 60`, `Community 93`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `Button()` connect `Community 64` to `Community 33`, `Community 2`, `Community 38`, `Community 7`, `Community 39`, `Community 9`, `Community 10`, `Community 71`, `Community 44`, `Community 12`, `Community 48`, `Community 19`, `Community 20`, `Community 86`, `Community 23`, `Community 25`, `Community 31`?**
