...
## Summary
- 2189 nodes · 3210 edges · 161 communities (149 shown, 12 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 31 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6e656047`
...
5. `feed` - 24 edges
6. `feed` - 24 edges
7. `relayAuthenticatedFetch()` - 21 edges
8. `users` - 19 edges
9. `errors` - 18 edges
10. `errors` - 18 edges
...
- `PATCH()` --calls--> `getApiBaseUrl()`  [EXTRACTED]
  app/api/users/me/route.ts → lib/api-server.ts
...
Cohesion: 0.07
Nodes (43): resolveAgentBaseUrl(), createSummaryGenerator(), GenerateSummaryFn, outboxEvents, IntuitionConfig, loadIntuitionConfig(), config, enqueueHelpRequestCreated() (+35 more)
...
Cohesion: 0.10
Nodes (28): GET(), GET(), GET(), HomePage(), Props, HelpRequestDetailPage(), PageProps, fetchAuthMe() (+20 more)
...
Cohesion: 0.10
Nodes (30): createAgentRoutingEvaluator(), CreateAgentRoutingEvaluatorOptions, evaluateRoutingFallback(), EvaluateRoutingFn, evaluate, fetchFn, result, createTagSuggestionEvaluator() (+22 more)
...
Cohesion: 0.12
Nodes (29): helpRequests, AuthenticatedUser, authorIdKeysFromRow(), authorIdMatchesUser(), isAdminRole(), JwtUser, LEGACY_USER_EMAIL, normalizeTitle() (+21 more)
...
Cohesion: 0.11
Nodes (26): conversationParticipants, denylistPatterns, helpRequestStatusEnum, mentorSubjects, messages, resourceStatusEnum, responses, subjectRequests (+18 more)

### Community 63 - "Community 63"
Cohesion: 0.13
Nodes (26): conversations, createConversationBodySchema, createMessageBodySchema, parseMessagesListQuery(), displayNameFromUser(), rowToSubjectSummary(), rowToUserProfile(), rowToUserPublicProfile() (+18 more)
...
Cohesion: 0.17
Nodes (15): POST(), getApiBaseUrl(), relayJsonWithCookies(), POST(), POST(), POST(), POST(), RouteContext (+7 more)

### Community 71 - "Community 71"
Cohesion: 0.16
Nodes (15): HelpRequestDetailClient(), loginAndRespond(), Props, loginAndCreate(), ApiErrorBody, ApiErrorInput, ApiErrorMessageKey, ApiRequestError (+7 more)
...
Cohesion: 0.15
Nodes (12): Props, AppShell(), AppShellProps, APP_SHELL_NAV, AppShellNav(), isNavActive(), LocaleSwitcher(), MentorNavLink() (+4 more)
...
Cohesion: 0.22
Nodes (9): AppDatabase, bookmarks, likes, getJwtUser(), fetchBookmarkedHelpRequests(), fetchHelpRequestsForAuthor(), helpRequestExists(), loadHelpRequestRow() (+1 more)

### Community 85 - "Community 85"
Cohesion: 0.25
Nodes (12): POST(), GET(), RouteContext, getAccessToken(), missingTokenResponse(), relayJsonResponse(), GET(), PATCH() (+4 more)
...
Cohesion: 0.15
Nodes (13): HomeContent(), fr, alert, createLink, cta, defaultParams, fr, links (+5 more)
...
Cohesion: 0.28
Nodes (10): FeedFilters(), Props, FeedPagination(), Props, Props, buildFeedQueryString(), feedHref(), feedPageHref() (+2 more)
...
Cohesion: 0.22
Nodes (7): CreateResult, HelpRequestForm(), MarketingPageShell(), MarketingPageShellProps, buildRubberduckRedirectUrl(), fetchRubberduckRedirectUrl(), url
...
## Knowledge Gaps
- **1354 isolated node(s):** `withNextIntl`, `__dirname`, `monorepoRoot`, `nextConfig`, `name` (+1349 more)
...
- **Why does `errors` connect `Community 81` to `Community 122`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **Why does `feed` connect `Community 8` to `Community 123`?**
  _High betweenness centrality (0.007) - this node is a cross-community bridge._
- **Why does `helpForm` connect `Community 114` to `Community 122`?**
