...
## Summary
- 1974 nodes · 2770 edges · 149 communities (138 shown, 11 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 30 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7f8b42ac`
...
Cohesion: 0.20
Nodes (15): IntuitionConfig, loadIntuitionConfig(), config, HELP_REQUEST_CREATED, IntuitionPublisherHandle, IntuitionPublisherLog, ProcessOutboxResult, processPendingOutboxEvents() (+7 more)
...
Cohesion: 0.08
Nodes (30): createAgentModerationEvaluator(), CreateAgentModerationEvaluatorOptions, EvaluateModerationFn, moderationEvaluateFallback(), evaluate, fetchFn, createAgentRoutingEvaluator(), CreateAgentRoutingEvaluatorOptions (+22 more)
...
Cohesion: 0.12
Nodes (25): denylistPatterns, helpRequests, subjectRequests, getJwtUser(), isAdminRole(), JwtUser, responseVisibleUnderCertificationFilter(), roleFromJwtClaims() (+17 more)

### Community 59 - "Community 59"
Cohesion: 0.14
Nodes (24): helpRequestStatusEnum, mentorSubjects, resourceStatusEnum, responses, subjectRequestStatusEnum, subjects, userRoleEnum, users (+16 more)
...
Cohesion: 0.12
Nodes (17): outboxEvents, enqueueHelpRequestCreated(), enqueueHelpRequestSummaryRequested(), HELP_REQUEST_SUMMARY_REQUESTED, normalizeTitle(), adminSubjectRequestPatchSchema, createDenylistPatternBodySchema, createHelpRequestBodySchema (+9 more)
...
Cohesion: 0.23
Nodes (8): AppDatabase, bookmarks, likes, fetchBookmarkedHelpRequests(), fetchHelpRequestsForAuthor(), helpRequestExists(), loadHelpRequestRow(), JwtPayload
...
## Knowledge Gaps
- **1246 isolated node(s):** `withNextIntl`, `__dirname`, `monorepoRoot`, `nextConfig`, `name` (+1241 more)
...
- **Why does `mentor` connect `Community 83` to `Community 113`?**
  _High betweenness centrality (0.005) - this node is a cross-community bridge._
- **Why does `HomeContent()` connect `Community 87` to `Community 2`, `Community 109`?**
  _High betweenness centrality (0.005) - this node is a cross-community bridge._
- **Why does `errors` connect `Community 73` to `Community 114`?**
