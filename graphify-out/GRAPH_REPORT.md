...
## Summary
- 2620 nodes · 3870 edges · 180 communities (167 shown, 13 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 31 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d5f5c0bd`
...
1. `getApiBaseUrl()` - 39 edges
2. `AppDatabase` - 38 edges
3. `profile` - 27 edges
4. `social` - 27 edges
5. `profile` - 27 edges
6. `social` - 27 edges
...
- `LoginPage()` --calls--> `sanitizeReturnTo()`  [EXTRACTED]
  app/[locale]/(app)/login/page.tsx → lib/sanitize-return-to.ts
...
Cohesion: 0.09
Nodes (27): GET(), HelpRequestDetailPage(), PageProps, FetchAuthMeResult, FetchFeedResult, fetchHelpRequest(), FetchHelpRequestResult, fetchJson() (+19 more)
...
Cohesion: 0.12
Nodes (15): Props, AppShell(), AppShellProps, APP_SHELL_NAV, AppShellNav(), isNavActive(), LocaleSwitcher(), MentorNavLink() (+7 more)

### Community 28 - "Community 28"
Cohesion: 0.15
Nodes (19): FeedFilters(), Props, FeedPagination(), Props, Props, excerpt(), PostCard(), PostCardLabels (+11 more)
...
Cohesion: 0.22
Nodes (10): GET(), HomePage(), Props, ExplorePage(), fetchFeed(), fetchSubjects(), parseFeedResponse(), parseSubjectsResponse() (+2 more)

### Community 40 - "Community 40"
Cohesion: 0.14
Nodes (13): helpNew, backHome, description, eyebrow, title, metadata, title, nav (+5 more)
...
Cohesion: 0.08
Nodes (24): MyListContent(), PasskeyManager(), patchProfile(), ProfileForm(), Props, Props, renderWithI18n(), fr (+16 more)
...
Cohesion: 0.11
Nodes (24): acceptLegal(), CguGate(), createResponse(), HelpRequestDetailClient(), Props, formatActionError(), MY_BOOKMARKS_QUERY_KEY, PostSocialActions() (+16 more)

### Community 75 - "Community 75"
Cohesion: 0.14
Nodes (20): HelpRequestDetailContent(), Props, MyListKind, Props, profileAvatarSrc(), ProfileContent(), profileInitials(), Props (+12 more)
...
Cohesion: 0.19
Nodes (20): POST(), POST(), POST(), GET(), RouteContext, getApiBaseUrl(), getAccessToken(), missingTokenResponse() (+12 more)

### Community 78 - "Community 78"
Cohesion: 0.12
Nodes (20): GET(), RouteContext, GET(), POST(), RouteContext, POST(), RouteContext, GET() (+12 more)

### Community 79 - "Community 79"
Cohesion: 0.12
Nodes (23): Alert(), AlertDescription(), AlertTitle(), alertVariants, AllVariants, ConnexionRequise, Default, Destructive (+15 more)
...
Cohesion: 0.17
Nodes (18): Card(), CardAction(), CardContent(), CardDescription(), CardFooter(), CardHeader(), CardTitle(), Default (+10 more)
...
Cohesion: 0.13
Nodes (14): Button(), buttonVariants, button, AllVariants, Error, Info, Story, Success (+6 more)
...
Cohesion: 0.26
Nodes (10): Props, UserProfilePagination(), Props, UserPublicPage(), fetchPublicUser(), buildPublicUserQueryString(), parsePublicUserSearchParams(), publicUserHref() (+2 more)
...
Cohesion: 0.38
Nodes (5): relayPublicGet(), upstreamQuerySuffix(), GET(), RouteContext, GET()
...
## Knowledge Gaps
- **1657 isolated node(s):** `withNextIntl`, `__dirname`, `monorepoRoot`, `nextConfig`, `name` (+1652 more)
...
- **Why does `profile` connect `Community 81` to `Community 40`, `Community 19`, `Community 22`?**
  _High betweenness centrality (0.021) - this node is a cross-community bridge._
- **Why does `profile` connect `Community 82` to `Community 41`, `Community 21`, `Community 23`?**
  _High betweenness centrality (0.015) - this node is a cross-community bridge._
- **Why does `errors` connect `Community 14` to `Community 41`?**
