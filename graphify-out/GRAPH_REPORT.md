...
## Summary
- 1516 nodes · 1912 edges · 131 communities (119 shown, 12 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 29 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7af55843`
...
6. `feed` - 14 edges
7. `feed` - 14 edges
8. `Plan opérationnel — Web, API, données (SSR, env, TanStack Query)` - 14 edges
9. `helpRequest` - 13 edges
10. `helpRequest` - 13 edges
...
- `GET()` --calls--> `getApiBaseUrl()`  [EXTRACTED]
  app/api/help-requests/[id]/route.ts → lib/api-server.ts
...
Cohesion: 0.06
Nodes (34): AgentRoutingEvaluateBody, AgentRoutingEvaluateResponse, AuthMeResponse, CertificationFilterMeta, CreateHelpRequestBody, CreateHelpRequestResponse, CreateResponseBody, CreateResponseResponse (+26 more)
...
Cohesion: 0.14
Nodes (21): authenticateWithDatabase(), authenticateWithMvpFallback(), isMvpPasswordFallbackEnabled(), LEGACY_USER_EMAIL, LoginBody, loginBodySchema, LoginSuccess, resolveLoginEmail() (+13 more)

### Community 51 - "Community 51"
Cohesion: 0.14
Nodes (18): bookmarks, helpRequests, helpRequestStatusEnum, likes, responses, userRoleEnum, getJwtUser(), fetchBookmarkedHelpRequests() (+10 more)
...
Cohesion: 0.15
Nodes (17): GET(), POST(), fetchMentorFeed(), getApiBaseUrl(), parseMentorFeedResponse(), POST(), GET(), MentorDashboardPage() (+9 more)
...
Cohesion: 0.17
Nodes (17): Select(), SelectContent(), SelectGroup(), SelectItem(), SelectLabel(), SelectScrollDownButton(), SelectScrollUpButton(), SelectSeparator() (+9 more)
...
Cohesion: 0.14
Nodes (17): HelpRequestDetailPage(), PageProps, GET(), RouteContext, fetchAuthMe(), FetchAuthMeResult, FetchFeedResult, fetchHelpRequest() (+9 more)
...
Cohesion: 0.18
Nodes (11): JwtUser, normalizeTitle(), responseVisibleUnderCertificationFilter(), roleFromJwtClaims(), tagsOverlap(), createHelpRequestBodySchema, createResponseBodySchema, FeedQueryParams (+3 more)
...
Cohesion: 0.23
Nodes (11): defaultSeedSubjects(), defaultSeedUsers(), runSeedIfConfigured(), seedSubjects(), SeedSubjectSpec, seedUsers(), SeedUserSpec, db (+3 more)
...
Cohesion: 0.47
Nodes (4): GET(), HomePage(), fetchFeed(), parseFeedResponse()
...
## Knowledge Gaps
- **991 isolated node(s):** `withNextIntl`, `__dirname`, `monorepoRoot`, `nextConfig`, `name` (+986 more)
...
- **Why does `mentor` connect `Community 67` to `Community 95`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 56` to `Community 69`, `Community 5`, `Community 6`, `Community 81`, `Community 49`, `Community 53`, `Community 57`, `Community 59`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
- **Why does `HomeContent()` connect `Community 1` to `Community 60`, `Community 101`?**
