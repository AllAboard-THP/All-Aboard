...
## Summary
- 1490 nodes · 1853 edges · 130 communities (118 shown, 12 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 29 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `594a8820`
...
Cohesion: 0.08
Nodes (38): GET(), GET(), HomePage(), POST(), HelpRequestDetailPage(), PageProps, GET(), RouteContext (+30 more)

### Community 1 - "Community 1"
Cohesion: 0.05
Nodes (46): defaultSeedSubjects(), defaultSeedUsers(), runSeedIfConfigured(), seedSubjects(), SeedSubjectSpec, seedUsers(), SeedUserSpec, address (+38 more)
...
Cohesion: 0.07
Nodes (29): AgentRoutingEvaluateBody, AgentRoutingEvaluateResponse, AuthMeResponse, CertificationFilterMeta, CreateHelpRequestBody, CreateHelpRequestResponse, CreateResponseBody, CreateResponseResponse (+21 more)
...
Cohesion: 0.16
Nodes (11): getJwtUser(), JwtUser, normalizeTitle(), responseVisibleUnderCertificationFilter(), roleFromJwtClaims(), tagsOverlap(), createHelpRequestBodySchema, createResponseBodySchema (+3 more)

### Community 57 - "Community 57"
Cohesion: 0.18
Nodes (14): helpRequests, helpRequestStatusEnum, responses, subjects, userRoleEnum, users, HelpRequestRow, ResponseRow (+6 more)
...
## Knowledge Gaps
- **980 isolated node(s):** `withNextIntl`, `__dirname`, `monorepoRoot`, `nextConfig`, `name` (+975 more)
...
- **Why does `Button()` connect `Community 52` to `Community 2`, `Community 5`, `Community 70`, `Community 48`, `Community 50`, `Community 86`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
- **Why does `mentor` connect `Community 63` to `Community 94`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
- **Why does `Badge()` connect `Community 13` to `Community 2`, `Community 50`, `Community 53`, `Community 5`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
