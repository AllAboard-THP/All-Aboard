...
## Summary
- 2734 nodes · 4044 edges · 178 communities (165 shown, 13 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 46 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1b9147ee`
...
1. `cn()` - 42 edges
2. `getApiBaseUrl()` - 39 edges
3. `AppDatabase` - 38 edges
4. `helpRequest` - 28 edges
5. `helpRequest` - 28 edges
6. `profile` - 27 edges
7. `social` - 27 edges
8. `profile` - 27 edges
9. `social` - 27 edges
10. `throwFromApiResponse()` - 27 edges
...
- `ResponseItem()` --calls--> `mapApiError()`  [EXTRACTED]
  components/features/help-request-detail-client.tsx → lib/map-api-error.ts
- `createHelpRequest()` --calls--> `throwFromApiResponse()`  [EXTRACTED]
  components/features/help-request-form.tsx → lib/map-api-error.ts
- `patchProfile()` --calls--> `throwFromApiResponse()`  [EXTRACTED]
  components/features/profile-form.tsx → lib/map-api-error.ts
...
Cohesion: 0.07
Nodes (40): createAgentModerationEvaluator(), createAgentRoutingEvaluator(), CreateAgentRoutingEvaluatorOptions, evaluateRoutingFallback(), EvaluateRoutingFn, evaluate, fetchFn, result (+32 more)
...
Cohesion: 0.09
Nodes (29): GET(), GET(), GET(), FetchAuthMeResult, FetchFeedResult, FetchHelpRequestResult, fetchJson(), fetchMentorFeed() (+21 more)

### Community 6 - "Community 6"
Cohesion: 0.10
Nodes (31): helpRequestStatusEnum, likes, mentorSubjects, resources, resourceStatusEnum, resourceTags, subjectRequestStatusEnum, userRoleEnum (+23 more)
...
Cohesion: 0.15
Nodes (19): acceptLegal(), CguGate(), formatActionError(), MY_BOOKMARKS_QUERY_KEY, Props, ApiErrorBody, ApiErrorInput, ApiErrorMessageKey (+11 more)
...
Cohesion: 0.17
Nodes (15): Props, PasskeyCredentialRow(), Props, Props, addPasskeyToAccount(), fetchPasskeyCredentials(), fetchPasskeyLoginOptions(), loginWithPasskey() (+7 more)
...
Cohesion: 0.32
Nodes (6): EditHelpRequestPage(), PageProps, HelpRequestDetailContent(), HelpRequestDetailPage(), PageProps, fetchHelpRequest()
...
Cohesion: 0.06
Nodes (56): POST(), POST(), POST(), POST(), POST(), RouteContext, GET(), RouteContext (+48 more)

### Community 72 - "Community 72"
Cohesion: 0.07
Nodes (41): bookmarks, helpRequests, subjectRequests, subjects, getJwtUser(), isAdminRole(), roleFromJwtClaims(), userAuthorIdKeys() (+33 more)

### Community 73 - "Community 73"
Cohesion: 0.11
Nodes (31): IntuitionConfig, loadIntuitionConfig(), config, enqueueHelpRequestCreated(), HELP_REQUEST_CREATED, IntuitionPublisherHandle, IntuitionPublisherLog, logPublishResult() (+23 more)
...
Cohesion: 0.16
Nodes (22): responses, users, AuthenticatedUser, authorIdKeysFromRow(), authorIdMatchesUser(), JwtUser, LEGACY_USER_EMAIL, normalizeTag() (+14 more)

### Community 84 - "Community 84"
Cohesion: 0.10
Nodes (19): MyListContent(), PostSocialActions(), refreshMock, renderCguGate(), Props, renderWithI18n(), fr, addButton (+11 more)
...
Cohesion: 0.13
Nodes (13): Props, AppShell(), AppShellProps, AppShellAuthActions(), AppShellUserMenu(), AppShellUserMenuProps, userInitials(), fetchAuthMe() (+5 more)

### Community 89 - "Community 89"
Cohesion: 0.19
Nodes (12): MyListKind, Props, profileAvatarSrc(), ProfileContent(), profileInitials(), Props, { Link, redirect, usePathname, useRouter, getPathname }, AppLocale (+4 more)

### Community 90 - "Community 90"
Cohesion: 0.15
Nodes (15): CreateAgentModerationEvaluatorOptions, EvaluateModerationFn, moderationEvaluateFallback(), evaluate, fetchFn, denylistPatterns, contentShouldBeFlagged(), isModerationClaudeEnabled() (+7 more)
...
Cohesion: 0.16
Nodes (12): ExplorePage(), ExploreContent(), Props, Props, SubjectIcon(), fetchSubjects(), ProfilePage(), fr (+4 more)
...
Cohesion: 0.19
Nodes (12): resolveAgentBaseUrl(), createSummaryGenerator(), GenerateSummaryFn, AppDatabase, outboxEvents, enqueueHelpRequestSummaryRequested(), HELP_REQUEST_SUMMARY_REQUESTED, AiSummaryWorkerHandle (+4 more)
...
## Knowledge Gaps
- **1722 isolated node(s):** `withNextIntl`, `__dirname`, `monorepoRoot`, `nextConfig`, `name` (+1717 more)
...
- **Why does `profile` connect `Community 10` to `Community 25`, `Community 43`, `Community 31`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `social` connect `Community 9` to `Community 44`?**
  _High betweenness centrality (0.015) - this node is a cross-community bridge._
- **Why does `errors` connect `Community 18` to `Community 44`?**
