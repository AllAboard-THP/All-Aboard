...
## Summary
- 2307 nodes · 3385 edges · 165 communities (154 shown, 11 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 31 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `00f512ea`
...
7. `errors` - 21 edges
8. `errors` - 21 edges
9. `relayAuthenticatedFetch()` - 21 edges
10. `auth` - 19 edges
...
- `ExplorePage()` --calls--> `fetchSubjects()`  [EXTRACTED]
  app/[locale]/(app)/explore/page.tsx → lib/api-server.ts
- `RegisterPage()` --calls--> `sanitizeReturnTo()`  [EXTRACTED]
  app/[locale]/(app)/register/page.tsx → lib/sanitize-return-to.ts
...
Cohesion: 0.07
Nodes (39): createResponse(), HelpRequestDetailClient(), Props, createHelpRequest(), CreateResult, HelpRequestForm(), MarketingPageShell(), MarketingPageShellProps (+31 more)
...
Cohesion: 0.09
Nodes (29): GET(), GET(), GET(), HomePage(), Props, ExplorePage(), HelpRequestDetailPage(), PageProps (+21 more)
...
Cohesion: 0.21
Nodes (18): ChallengeType, consumeChallenge(), RegistrationChallengeMetadata, saveChallenge(), challengeTtlMs(), webauthnOrigins(), webauthnRpId(), webauthnRpName() (+10 more)
...
Cohesion: 0.08
Nodes (41): createSummaryGenerator(), GenerateSummaryFn, outboxEvents, IntuitionConfig, loadIntuitionConfig(), config, enqueueHelpRequestCreated(), HELP_REQUEST_CREATED (+33 more)

### Community 58 - "Community 58"
Cohesion: 0.10
Nodes (33): AppDatabase, bookmarks, conversationParticipants, denylistPatterns, helpRequests, helpRequestStatusEnum, likes, resourceStatusEnum (+25 more)
...
Cohesion: 0.12
Nodes (29): responses, enqueueHelpRequestSummaryRequested(), AuthenticatedUser, authorIdKeysFromRow(), authorIdMatchesUser(), isAdminRole(), JwtUser, LEGACY_USER_EMAIL (+21 more)
...
Cohesion: 0.13
Nodes (27): conversations, messages, createConversationBodySchema, createMessageBodySchema, parseMessagesListQuery(), displayNameFromUser(), rowToSubjectSummary(), rowToUserProfile() (+19 more)
...
Cohesion: 0.18
Nodes (19): createPool(), jwtSecret(), registerAdminRoutes(), registerAuthRoutes(), registerConversationRoutes(), registerConversationWsRoutes(), registerFeedRoutes(), registerHelpRequestRoutes() (+11 more)
...
Cohesion: 0.12
Nodes (17): HomeContent(), alert, createLink, cta, defaultParams, fr, links, list (+9 more)
...
Cohesion: 0.22
Nodes (13): POST(), GET(), RouteContext, getAccessToken(), missingTokenResponse(), relayJsonResponse(), POST(), GET() (+5 more)

### Community 83 - "Community 83"
Cohesion: 0.18
Nodes (14): POST(), getApiBaseUrl(), relayJsonWithCookies(), POST(), POST(), POST(), RouteContext, body (+6 more)
...
Cohesion: 0.24
Nodes (10): Props, excerpt(), PostCard(), PostCardLabels, Props, Props, UnansweredWidget(), card (+2 more)
...
Cohesion: 0.28
Nodes (9): FeedFilters(), Props, FeedPagination(), Props, buildFeedQueryString(), feedHref(), feedPageHref(), FeedPageParams (+1 more)
...
Cohesion: 0.28
Nodes (7): createAgentRoutingEvaluator(), CreateAgentRoutingEvaluatorOptions, evaluateRoutingFallback(), EvaluateRoutingFn, evaluate, fetchFn, result
...
Cohesion: 0.39
Nodes (5): resolveAgentBaseUrl(), createTagSuggestionEvaluator(), SuggestTagsFn, suggestTagsBodySchema, registerSuggestTagsRoutes()
...
## Knowledge Gaps
- **1438 isolated node(s):** `withNextIntl`, `__dirname`, `monorepoRoot`, `nextConfig`, `name` (+1433 more)
...
- **Why does `errors` connect `Community 8` to `Community 126`?**
  _High betweenness centrality (0.007) - this node is a cross-community bridge._
- **Why does `feed` connect `Community 69` to `Community 126`?**
  _High betweenness centrality (0.005) - this node is a cross-community bridge._
- **Why does `errors` connect `Community 9` to `Community 127`?**
  _High betweenness centrality (0.005) - this node is a cross-community bridge._
