...
## Summary
- 2678 nodes · 3965 edges · 180 communities (166 shown, 14 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 31 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `149866a7`
...
3. `helpRequest` - 28 edges
4. `helpRequest` - 28 edges
5. `profile` - 27 edges
6. `social` - 27 edges
7. `profile` - 27 edges
8. `social` - 27 edges
9. `throwFromApiResponse()` - 27 edges
10. `cn()` - 27 edges
...
- `ProfilePage()` --calls--> `fetchSubjects()`  [EXTRACTED]
  app/[locale]/(app)/profile/page.tsx → lib/api-server.ts
...
Cohesion: 0.08
Nodes (33): GET(), GET(), EditHelpRequestPage(), PageProps, ExplorePage(), fetchAuthMe(), FetchAuthMeResult, FetchFeedResult (+25 more)
...
Cohesion: 0.35
Nodes (9): POST(), POST(), POST(), getAccessToken(), missingTokenResponse(), relayJsonResponse(), relayPostJson(), GET() (+1 more)
...
Cohesion: 0.13
Nodes (21): createResponse(), Props, formatActionError(), MY_BOOKMARKS_QUERY_KEY, PostSocialActions(), Props, throwFromApiResponse(), addPasskeyToAccount() (+13 more)
...
Cohesion: 0.08
Nodes (31): HelpRequestDetailClient(), Props, ResponseItem(), HelpRequestEditForm(), Props, tagsToRaw(), HelpRequestOwnerActions(), Props (+23 more)
...
Cohesion: 0.07
Nodes (27): Props, AppShell(), AppShellProps, acceptLegal(), CguGate(), MyListContent(), PasskeyManager(), fr (+19 more)
...
Cohesion: 0.17
Nodes (14): GET(), GET(), RouteContext, POST(), getApiBaseUrl(), parseFeedResponse(), relayJsonWithCookies(), POST() (+6 more)
...
Cohesion: 0.27
Nodes (8): POST(), POST(), relayPostJsonWithCookies(), relayPublicGet(), upstreamQuerySuffix(), GET(), RouteContext, GET()
...
Cohesion: 0.11
Nodes (28): bookmarks, helpRequests, helpRequestStatusEnum, likes, resourceStatusEnum, subjectRequests, subjectRequestStatusEnum, subjects (+20 more)
...
Cohesion: 0.10
Nodes (23): HelpRequestDetailContent(), Props, PasskeyCredentialRow(), Props, profileAvatarSrc(), ProfileContent(), profileInitials(), Props (+15 more)
...
Cohesion: 0.11
Nodes (25): HomePage(), Props, FeedFilters(), Props, FeedPagination(), Props, Props, MyListKind (+17 more)
...
Cohesion: 0.13
Nodes (24): mentorSubjects, outboxEvents, responses, users, enqueueHelpRequestCreated(), enqueueHelpRequestSummaryRequested(), HELP_REQUEST_SUMMARY_REQUESTED, authorIdKeysFromRow() (+16 more)

### Community 84 - "Community 84"
Cohesion: 0.13
Nodes (18): RouteContext, GET(), POST(), RouteContext, POST(), RouteContext, GET(), DELETE() (+10 more)
...
Cohesion: 0.13
Nodes (22): AuthenticatedUser, authorIdMatchesUser(), getJwtUser(), isAdminRole(), JwtUser, LEGACY_USER_EMAIL, normalizeTitle(), resolveAuthenticatedUser() (+14 more)
...
Cohesion: 0.13
Nodes (15): createAgentModerationEvaluator(), CreateAgentModerationEvaluatorOptions, moderationEvaluateFallback(), evaluate, fetchFn, CreateAgentRoutingEvaluatorOptions, evaluateRoutingFallback(), EvaluateRoutingFn (+7 more)

### Community 95 - "Community 95"
Cohesion: 0.18
Nodes (20): createAgentRoutingEvaluator(), createPool(), jwtSecret(), registerAdminRoutes(), registerAuthRoutes(), registerConversationRoutes(), registerConversationWsRoutes(), registerFeedRoutes() (+12 more)

### Community 96 - "Community 96"
Cohesion: 0.16
Nodes (16): createDb(), defaultSeedSubjects(), defaultSeedUsers(), runSeedIfConfigured(), seedMentorSubjectsForAlice(), seedSubjects(), SeedSubjectSpec, seedUsers() (+8 more)
...
Cohesion: 0.20
Nodes (15): Props, UserProfilePagination(), excerpt(), profileAvatarSrc(), profileInitials(), Props, ResponseListItem(), UserPublicContent() (+7 more)
...
Cohesion: 0.43
Nodes (4): createTagSuggestionEvaluator(), SuggestTagsFn, suggestTagsBodySchema, registerSuggestTagsRoutes()
...
## Knowledge Gaps
- **1697 isolated node(s):** `withNextIntl`, `__dirname`, `monorepoRoot`, `nextConfig`, `name` (+1692 more)
...
- **Why does `profile` connect `Community 90` to `Community 28`, `Community 21`, `Community 46`?**
  _High betweenness centrality (0.015) - this node is a cross-community bridge._
- **Why does `auth` connect `Community 18` to `Community 47`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
- **Why does `profile` connect `Community 9` to `Community 23`, `Community 29`, `Community 47`?**
