...
## Summary
- 1590 nodes · 2106 edges · 135 communities (123 shown, 12 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 29 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e675a3a5`
...
8. `feed` - 14 edges
9. `feed` - 14 edges
10. `Plan opérationnel — Web, API, données (SSR, env, TanStack Query)` - 14 edges
...
Cohesion: 0.04
Nodes (45): AcceptLegalResponse, AgentRoutingEvaluateBody, AgentRoutingEvaluateResponse, AuthMeResponse, CertificationFilterMeta, CreateHelpRequestBody, CreateHelpRequestResponse, CreateResponseBody (+37 more)
...
Cohesion: 0.16
Nodes (18): createDb(), createPool(), jwtSecret(), registerAuthRoutes(), registerFeedRoutes(), registerHelpRequestRoutes(), registerLegalRoutes(), registerMeRoutes() (+10 more)
...
Cohesion: 0.16
Nodes (13): bookmarks, likes, fetchBookmarkedHelpRequests(), fetchHelpRequestsForAuthor(), helpRequestExists(), loadHelpRequestRow(), HelpRequestRow, ResponseRow (+5 more)

### Community 5 - "Community 5"
Cohesion: 0.16
Nodes (20): helpRequests, helpRequestStatusEnum, outboxEvents, userRoleEnum, IntuitionConfig, loadIntuitionConfig(), config, enqueueHelpRequestCreated() (+12 more)
...
Cohesion: 0.05
Nodes (39): address, aliceToken, authors, bobHeaders, bobToken, body, charlieToken, created (+31 more)
...
Cohesion: 0.12
Nodes (21): Alert(), AlertDescription(), AlertTitle(), alertVariants, AllVariants, ConnexionRequise, Default, Destructive (+13 more)

### Community 52 - "Community 52"
Cohesion: 0.16
Nodes (19): mentorSubjects, responses, subjects, users, SeedSubjectSpec, SeedUserSpec, getJwtUser(), displayNameFromUser() (+11 more)

### Community 53 - "Community 53"
Cohesion: 0.11
Nodes (18): Badge(), badgeVariants, Default, FeedItemPlaceholder, Story, FeedEmpty, MentorFeedEmpty, NotFound (+10 more)
...
Cohesion: 0.14
Nodes (14): JwtUser, normalizeTitle(), responseVisibleUnderCertificationFilter(), roleFromJwtClaims(), tagsOverlap(), createHelpRequestBodySchema, createResponseBodySchema, FeedQueryParams (+6 more)
...
Cohesion: 0.36
Nodes (8): AppDatabase, buildFeedConditions(), countFeedItems(), fetchFeedRows(), fetchUnansweredRows(), mentorFeedWhere, resolveSubjectIdBySlug(), parseFeedQuery()

### Community 87 - "Community 87"
Cohesion: 0.22
Nodes (9): defaultSeedSubjects(), defaultSeedUsers(), runSeedIfConfigured(), seedSubjects(), seedUsers(), db, pool, specs (+1 more)
...
## Knowledge Gaps
- **1019 isolated node(s):** `withNextIntl`, `__dirname`, `monorepoRoot`, `nextConfig`, `name` (+1014 more)
...
- **Why does `mentor` connect `Community 67` to `Community 98`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
- **Why does `HomeContent()` connect `Community 88` to `Community 3`, `Community 100`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
- **Why does `common` connect `Community 102` to `Community 98`?**
