...
## Summary
- 1754 nodes · 2461 edges · 141 communities (129 shown, 12 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 29 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f48f4bf9`
...
Cohesion: 0.14
Nodes (22): resources, resourceTags, rowToResource(), buildResourcesSearchCondition(), countPublishedResources(), fetchPublishedResourceRows(), publishedResourcesWhere(), createResourceBodySchema (+14 more)

### Community 5 - "Community 5"
Cohesion: 0.14
Nodes (23): authenticateWithDatabase(), authenticateWithMvpFallback(), isMvpPasswordFallbackEnabled(), LEGACY_USER_EMAIL, LoginBody, loginBodySchema, LoginSuccess, resolveLoginEmail() (+15 more)

### Community 6 - "Community 6"
Cohesion: 0.14
Nodes (25): createConversationBodySchema, createMessageBodySchema, parseMessagesListQuery(), displayNameFromUser(), rowToSubjectSummary(), rowToUserProfile(), rowToUserPublicProfile(), SubjectRow (+17 more)
...
Cohesion: 0.14
Nodes (18): buildFeedConditions(), countFeedItems(), feedPublicVisibility, fetchFeedRows(), fetchUnansweredRows(), mentorFeedWhere, resolveSubjectIdBySlug(), adminSubjectRequestPatchSchema (+10 more)
...
Cohesion: 0.12
Nodes (19): bookmarks, getJwtUser(), isAdminRole(), JwtUser, normalizeTag(), normalizeTitle(), responseVisibleUnderCertificationFilter(), roleFromJwtClaims() (+11 more)
...
Cohesion: 0.16
Nodes (17): helpRequests, subjectRequests, subjects, DenylistPatternRow, HelpRequestRow, ResourceRow, ResponseRow, rowToDenylistPattern() (+9 more)
...
Cohesion: 0.20
Nodes (17): createPool(), jwtSecret(), registerAdminRoutes(), registerAuthRoutes(), registerConversationRoutes(), registerFeedRoutes(), registerHelpRequestRoutes(), registerLegalRoutes() (+9 more)
...
Cohesion: 0.14
Nodes (14): conversationParticipants, conversations, denylistPatterns, helpRequestStatusEnum, likes, messages, resourceStatusEnum, subjectRequestStatusEnum (+6 more)
...
Cohesion: 0.22
Nodes (9): HomeContent(), alert, createLink, cta, fr, links, list, renderHome() (+1 more)
...
Cohesion: 0.31
Nodes (5): fr, mockFetch, renderWithClient(), Props, renderWithI18n()
...
## Knowledge Gaps
- **1094 isolated node(s):** `withNextIntl`, `__dirname`, `monorepoRoot`, `nextConfig`, `name` (+1089 more)
...
- **Why does `mentor` connect `Community 74` to `Community 104`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
- **Why does `HomeContent()` connect `Community 95` to `Community 106`, `Community 3`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
- **Why does `common` connect `Community 108` to `Community 104`?**
