...
## Summary
- 2223 nodes · 3257 edges · 163 communities (152 shown, 11 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 31 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1fb98e71`
...
- `HomePage()` --calls--> `fetchSubjects()`  [EXTRACTED]
...
Cohesion: 0.09
Nodes (36): AppDatabase, bookmarks, denylistPatterns, helpRequests, helpRequestStatusEnum, likes, mentorSubjects, resourceStatusEnum (+28 more)
...
Cohesion: 0.10
Nodes (34): responses, AuthenticatedUser, authorIdKeysFromRow(), authorIdMatchesUser(), isAdminRole(), JwtUser, LEGACY_USER_EMAIL, normalizeTitle() (+26 more)
...
Cohesion: 0.11
Nodes (22): GET(), GET(), ExplorePage(), HelpRequestDetailPage(), PageProps, fetchAuthMe(), FetchAuthMeResult, FetchFeedResult (+14 more)
...
Cohesion: 0.17
Nodes (14): GET(), POST(), getApiBaseUrl(), parseMentorFeedResponse(), POST(), POST(), RouteContext, body (+6 more)
...
Cohesion: 0.22
Nodes (10): HelpRequestDetailContent(), Props, { Link, redirect, usePathname, useRouter, getPathname }, AppLocale, routing, fetchMentorFeed(), formatDateTime(), localeToBcp47 (+2 more)
...
Cohesion: 0.16
Nodes (11): ExploreContent(), Props, Props, SubjectIcon(), fr, grid, links, renderExplore() (+3 more)
...
Cohesion: 0.38
Nodes (8): POST(), GET(), RouteContext, getAccessToken(), missingTokenResponse(), relayJsonResponse(), GET(), PATCH()
...
Cohesion: 0.33
Nodes (3): detailUrl, searchTerm, title
...
## Knowledge Gaps
- **1377 isolated node(s):** `withNextIntl`, `__dirname`, `monorepoRoot`, `nextConfig`, `name` (+1372 more)
...
- **Why does `errors` connect `Community 83` to `Community 124`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **Why does `feed` connect `Community 70` to `Community 125`?**
  _High betweenness centrality (0.007) - this node is a cross-community bridge._
- **Why does `helpForm` connect `Community 115` to `Community 125`?**
